...
### Try  again
A PC may not try the same skill check twice on the same challenge. This may lead to another party member taking a crack at it. When this happens the other party members will each **Take a Ten**. For every PC who makes an attempt 10 minutes will pass. This keeps it in your best interest to always put your best roll forward.

## Success at a Cost
If a player fails a check but only by a little a DM may offer them a negative consequence in exchange for success. You dodge the fireball, but you are prone at the feet of an enemy. You manage to get their purse, but they notice you and call for the guards.

## Degrees of Failure
A DM may opt to say a failed Disarm Trap check by less than 5 doesn't set off the trap, but a failure of 5 or more does.

## Press your Luck
A skill check has failed and there is not time for another player to **Try Again** or the original character *Really* wants to take another try. The DM may offer an assured additional negative consequence, or an additional risk should the next attempt fail, in exchange for an additional attempt.
**Examples: **
- You fail to pick a lock, you may try again but if you fail the lock will break.
- You attempt to walk across the beam. If you stop now you can safely retreat back to the start, or at the risk of falling 60ft to the depths below you can try again.
- You have failed your Athletics check to hold the gate open, meaning it will fall and trap everyone inside. You can try again, but you will suffer exhaustion. A different player may try to help in order to grant advantage but the gate will fully close if you fail.
...
## Travel
The players will all complete the following skill checks if they are at risk of an encounter during travel.
- Survival to ensure you arrive safely, find cover from weather, tracking a target, or find a place to rest.
- Stealth to ensure you were not followed, did not attract a predator, hid your resting place.
- Perception to ensure you do not get lost, ambushed, or detect other potential complications.
- A player may roll a different skill, or perform a different action (such as casting spell), if they can justify it.

A critical success will cancel a different players failure. A critical failure will cancel another players success.

The results of each skill check will be considered by the DM when setting up the encounter.
